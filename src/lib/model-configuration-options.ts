...
{ id: "nozzle_diameter", type: ConfigOptionType.coStrings, fixed: false, requiredInUser: true, requiredInInstalled: true, label: "Nozzle diameter", tooltip: "Diameters of nozzles of the printers. 'printer_variant' in the Printer configuration should point to this", default: "", delimiter:";"},
...
{ id: "default_materials", type: ConfigOptionType.coStrings, fixed: false,  label: "Default Materials", tooltip: "Default materials for the printers", default: "", delimiter:";", search: "filament"}
]
